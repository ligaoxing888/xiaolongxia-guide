# 🦞 全网最高效安装小龙虾（OpenClaw）方案（Claude Code版）
...
| 梯子 | 稳定节点，全局 + Tun 模式（注册 ChatGPT 必须） |
| 时间 | 约 10 分钟 |
...
小龙虾支持 20+ 聊天平台。推荐两个：
- **Telegram**：体验最好，功能最全，我自己用的（需要海外手机号注册）
...
| **安装耗时** | 约 10 分钟 | 约 3 小时 |
| **AI 模型** | GPT-5.4（免费版） | Claude Opus（目前最强之一） |
...
>
> 有问题？加微信 **ligaoxing-888**，交流更多养虾经验。
