...
| 平台 | 门槛 | 说明 |
|------|------|------|
| **Telegram** | 需要海外手机号 | 体验最好，功能最全，我自己用的 |
| **飞书** | 国内直接注册 | 零门槛，适合国内用户 |
| **微信** | 需装社区插件 | 非官方，用 iPad 协议，有一定风险 |
| **Discord** | 免费注册 | 适合有 Discord 的用户 |
| **WhatsApp** | 需要手机号 | 海外用户首选 |

**不知道选什么？**
- 有海外手机号 → Telegram（我的推荐）
- 没有海外手机号、想最快上手 → 飞书
- 一定要用微信 → 可以，但要接受社区插件的不确定性
